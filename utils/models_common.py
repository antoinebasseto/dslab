...
from utils.droplet_retriever import create_dataset, resize_patch
import numpy as np
...
def create_embeddings(device, dataloader, config, model):
    model.eval()
...
class FolderDataset(Dataset):
    ...
    def convert_to_float(self, value):
        ...
        return np.uint16(value).astype(np.float32)
