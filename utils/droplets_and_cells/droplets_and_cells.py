...
def generate_output(input_string, output_string_droplets, output_string_cells, refine, optional_output_directory, optional_output):
    print("WARNING: Not recommended. Droplet detection is better when using populate_data with --alt_franc flag enabled. alt_franc makes preprocessing for droplet detection.")
...
def main(argv):
    assert(False and "Deprecated. Use populate_data.py to get droplet dataset")
    imgname = ''
    path = ''
    suffix = '.nd2'
